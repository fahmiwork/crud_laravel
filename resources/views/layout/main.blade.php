              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{(request()->segment('1')== 'students') ? 'active' : ''}}" aria-current="page" href="{{ url('students')}}">
                      <i class="fas fa-tachometer-alt"></i> Students
                    </a>
                  </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link {{(request()->segment('1')== 'kategori_products') ? 'active' : ''}}" aria-current="page" href="{{ url('kategori_products')}}">
                      <i class="fas fa-users"></i> Kategori Products
                  </a>
              </li>
